-- @description simple track cleanup script
-- @version 1.0
-- @author bernelius
-- @about:
...
for i = total - 1, 0, -1 do
    ...
    if
        (not name or name == "" or has_default_name or is_stem)
        and fx_count == 0
        and has_no_media
        and not is_folder
    ...
    elseif (not name or name == "" or has_default_name) and has_no_media and fx_count == 0 and not is_folder then
    ...
    elseif
        (not name or name == "" or has_default_name)
        and has_no_media
        and is_folder
        and not has_receives
        and not has_sends
